...
<div class="section">
    <div class="row">
          <div class="col s12">
		  <h5>Budapest XXII. kerület</h5><br/> 
 ...
 <h5><strong>A Fidesz jelöltjének kihívója: Havasi Gábor  </strong></h5>
<br/>
<table class="striped">
              <thead>
                <tr>
			...
			<tr>
			<td>Havasi Gábor - MOMENTUM-DK-MSZP-PÁRBESZÉD-LMP <img src="images/kozos_ellenzek_logo.png" style="width:180px;height:30px;"></td> 
...
<br/>
<br/>
<h5><strong><a id="webURL" href="https://static.valasztas.hu/dyn/onk14/szavossz/hu/M01/T022/tjk.html">2014-es polgármester-választás eredménye</a></strong></h5><br/>
