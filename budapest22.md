---
layout: page
title: Budapest XXII. kerület
permalink: /budapest22
---
...
<div class="section">
    <div class="row">
          <div class="col s12">
		  <h5>Budapest XXII. kerület</h5>
<br/>
<h5><strong><a id="webURL" href="http://www.valasztas.hu/dyn/onk14/szavossz/hu/M01/T022/tjk.html">2014-es polgármester-választás eredménye</a></strong></h5>
<br/>
<iframe src="https://datastudio.google.com/embed/reporting/1cNSVSA70K2eq3LFj1NolaTdcqjgr9eKE/page/TQym" frameborder="0" style="border:0" allowfullscreen style="height: 80vh; width: 100vh; object-fit: contain"></iframe>
			...
			<table class="striped">
             ...
             <tr>
				   ...
				   <td id="fidesz_mayor2">8,964</td>
			</tr>
			<tr>
			<td>Gréczi Zsolt - DK <img src="images/dk_logo.png" style="width:34px;height:30px;"></td> 
			<td id="ellenzek_mayor">15.3%</td>
			<td id="ellenzek_mayor2">2,838</td>
			</tr>
              </tbody>
            </table>
<br/>
...
<br/><h5><strong>2018-as országos listás eredmények</strong></h5><br/><img src="images/listas_charts/budapest22.png" style="height: 100%; width: 100%; object-fit: contain"><br/>
