...
<td id="id_egyutt">0.6%</td>
			...
			<h5>Várható győztes: <span id="gyoztes">Fidesz, </span><span id="esely">87%</span><span>-os győzelmi esély</span></h5>
			<h6><strong>Legesélyesebb ellenzéki jelölt: <span id="masodik">Jobbik, </span><span id="esely2">13%</span><span>-os győzelmi esély</span></strong></h6>
			<br/>
			<h6><strong>Becslés megbízhatósága: Valószínű</strong></h6>
<br/><h6>Megjegyzés a kerülethez: Szoros eredmény várható, koordináció esetén könnyen nyerhet a Jobbik is.</h6>
