...
<div class="section">
 ...
 <h5><strong>A Fidesz jelöltjének kihívója: Veres Pál</strong></h5>
<br/>
<table class="striped">
              <thead>
                <tr>
              ...
              <tbody>
             <tr>
                   <td>Alakszai Zoltán - FIDESZ-KDNP <img src="images/fideszkdnp_logo.png" style="width:55px;height:30px;"></td>
				   <td id="fidesz_mayor">48.9%</td>
			</tr>
			<tr>
			<td>Veres Pál - Függetlenek Szíve-MSZP-MOMENTUM-PÁRBESZÉD-JOBBIK-DK-MMM-Velünk a Város</td> 
			<td id="ellenzek_mayor">44.6%</td>
			</tr>
              </tbody>
            </table>
<br/>
<br/>
<h5><strong><a id="webURL" href="https://static.valasztas.hu/dyn/onk14/szavossz/hu/M05/T202/tjk.html">2014-es polgármester-választás eredménye</a></strong></h5><br/>
...
<br/>
			...
			<table class="striped">
              ...
              <tbody>
             <tr>
                   <td>	Dr. Kriza Ákos - Fidesz-KDNP <img src="images/fideszkdnp_logo.png" style="width:55px;height:30px;"></td>
...
<th>Kompenzációs helyek</th>
             ...
             <tr>
                  <td>Fidesz-KDNP <img src="images/fideszkdnp_logo.png" style="width:55px;height:30px;"></td>
				   <td id="fidesz_mp">16</td><td id="fidesz_mp_lista">1</td>
			</tr>
			<tr><td>Jobbik <img src="images/jobbik_logo.png" style="width:23px;height:30px;"></td>
				<td id="jobbik_mp">2</td><td id="jobbik_mp_lista">3</td>
			</tr>
			<tr>
