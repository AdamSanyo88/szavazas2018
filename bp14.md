...
<table class="striped">
			...
			<tr><td>Szilágyi György - Jobbik <img src="images/jobbik_logo.png" style="width:23px;height:30px;"></td><td id="id_jobbik">8.8%</td></tr>
<tr>
...
<tr>
<td>Kóber György Márk -  Együtt <img src="images/egyutt_logo.png" style="width:31px;height:30px;"></td>
<td id="id_egyutt">1.9%</td>
			...
			<h6>Legesélyesebb ellenzéki jelölt: <span id="masodik">MSZP-Párbeszéd/DK, </span><span id="esely2">15%</span><span>-os győzelmi esély</span></h6>
			<br/>
			<h6>Becslés megbízhatósága: Valószínű</h6>
<br/><h6>Megjegyzés a kerülethez: Az átlagnál erősebb budapesti körzet, ahol azonban van esélye a baloldalnak is a győzelemre.</h6>
          </div>
    </div>
</div>
