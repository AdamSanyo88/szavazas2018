...
<div class="section">
    <div class="row">
		  ...
		  <h5>Budaörs</h5>
<br/>
<h5><strong><a id="webURL" href="http://www.valasztas.hu/dyn/onk14/szavossz/hu/M14/T015/tjk.html">2014-es polgármester-választás eredménye</a></strong></h5>
<br/>
<img src="images/2014_onkormanyzat/budaors.png" style="height: 100%; width: 100%; object-fit: contain">
			...
			<table class="striped">
              ...
              <tbody>
             <tr>
                   <td>Török István Zoltán - Fidesz-KDNP <img src="images/fideszkdnp_logo.png" style="width:55px;height:30px;"></td>
				   <td id="fidesz_mayor">27.4%</td>
				   <td id="fidesz_mayor2">3,171</td>
			</tr>
			<tr>
			<td>Wittinghoff Tamás - BFE</td> 
			<td id="ellenzek_mayor">69.3%</td>
			<td id="ellenzek_mayor2">8,029</td>
			</tr>
              </tbody>
            </table>
<br/>
			...
			<tr>
			 ...
			 <tr>
                  <td>Egyéb szervezet</td>
				   <td id="egyeb_mp">10 *</td><td id="egyeb_mp_lista"></td>
			</tr>
             <tr>
                  <td>Független</td>
...
<p><span id="megjegyzes">* BFE jelölt</span><br/></p>
<br/><h5><strong>2018-as országos listás eredmények</strong></h5><br/><img src="images/listas_charts/budaors.png" style="height: 100%; width: 100%; object-fit: contain"><br/>
			...
			<table class="striped">
             ...
             <tr>
                  <td>Fidesz <img src="images/fideszkdnp_logo.png" style="width:55px;height:30px;"></td>
				   <td id="fidesz_2018">38.5%</td>
			</tr>
			<tr><td>Jobbik <img src="images/jobbik_logo.png" style="width:23px;height:30px;"></td> 
			<td id="jobbik_2018">12.2%</td>
			</tr>
			<tr>
