...
<div class="section">
    <div class="row">
		  ...
		  <h5>Keszthely</h5>
<br/>
<h5><strong><a id="webURL" href="http://www.valasztas.hu/dyn/onk14/szavossz/hu/M20/T093/tjk.html">2014-es polgármester-választás eredménye</a></strong></h5>
<br/>
<img src="images/2014_onkormanyzat/keszthely.png" style="height: 100%; width: 100%; object-fit: contain">
			...
			<table class="striped">
              ...
              <tbody>
             <tr>
                   <td>	Ruzsics Ferenc - Fidesz-KDNP <img src="images/fideszkdnp_logo.png" style="width:55px;height:30px;"></td>
				   <td id="fidesz_mayor">53.1%</td>
				   <td id="fidesz_mayor2">3,142</td>
			</tr>
			<tr>
			<td>Selmeczy Zsuzsanna - <img src="images/jobbik_logo.png" style="width:23px;height:30px;"></td> 
			<td id="ellenzek_mayor">22.4%</td>
			<td id="ellenzek_mayor2">1,327</td>
			</tr>
              </tbody>
            </table>
<br/>
...
<br/><h5><strong>2018-as országos listás eredmények</strong></h5><br/><img src="images/listas_charts/keszthely.png" style="height: 100%; width: 100%; object-fit: contain"><br/>
