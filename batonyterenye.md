...
<div class="section">
    <div class="row">
		  ...
		  <h5>Bátonyterenye</h5>
<br/>
<h5><strong><a id="webURL" href="http://www.valasztas.hu/dyn/onk14/szavossz/hu/M13/T006/tjk.html">2014-es polgármester-választás eredménye</a></strong></h5><br/>
...
<th>Kompenzációs helyek</th>
			...
			<tr>
                  <td>DK <img src="images/dk_logo.png" style="width:34px;height:30px;"></td>
				   <td id="dk_mp">1 *</td><td id="dk_mp_lista">1</td>
			</tr>
			<tr>
