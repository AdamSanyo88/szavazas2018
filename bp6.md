...
<td id="id_egyutt">2.1%</td>
			...
			<h6><strong>Legesélyesebb ellenzéki jelölt: <span id="masodik">MSZP-Párbeszéd/DK, </span><span id="esely2">81%</span><span>-os győzelmi esély</span></strong></h6>
			<br/>
			<h6><strong>Becslés megbízhatósága: Valószínű</strong></h6>
<br/><h6>Megjegyzés a kerülethez: Klasszikus kétesélyes kerület, ahol a Fidesz megszoríthatja az ellenzéki jelöltet.</h6>
          </div>
    </div>
</div>
