...
<div class="section">
    <div class="row">
		  ...
		  <h5>Nyírbátor</h5>
<br/>
<h5><strong><a id="webURL" href="http://www.valasztas.hu/dyn/onk14/szavossz/hu/M16/T112/tjk.html">2014-es polgármester-választás eredménye</a></strong></h5>
<br/>
<img src="images/2014_onkormanyzat/nyirbator.png" style="height: 100%; width: 100%; object-fit: contain">
			...
			<table class="striped">
              ...
              <tbody>
             <tr>
                   <td>Dr. Trefán Szabolcs - Fidesz-KDNP <img src="images/fideszkdnp_logo.png" style="width:55px;height:30px;"></td>
				   <td id="fidesz_mayor">38.1%</td>
				   <td id="fidesz_mayor2">1,999</td>
			</tr>
			<tr>
			<td>Máté Antal - Független</td> 
			<td id="ellenzek_mayor">47.7%</td>
			<td id="ellenzek_mayor2">2,506</td>
			</tr>
              </tbody>
            </table>
<br/>
...
<th>Kompenzációs helyek</th>
			...
			<tr>
                  <td>MSZP <img src="images/mszp2_logo.png" style="width:30px;height:30px;"></td>
				   <td id="mszp_mp">6</td><td id="mszp_mp_lista"></td>
			</tr>
			<tr>
...
<br/><h5><strong>2018-as országos listás eredmények</strong></h5><br/><img src="images/listas_charts/nyirbator.png" style="height: 100%; width: 100%; object-fit: contain"><br/>
			...
			<table class="striped">
             ...
             <tr>
                  <td>Fidesz <img src="images/fideszkdnp_logo.png" style="width:55px;height:30px;"></td>
				   <td id="fidesz_2018">45.9%</td>
			</tr>
			<tr><td>Jobbik <img src="images/jobbik_logo.png" style="width:23px;height:30px;"></td> 
			<td id="jobbik_2018">20.4%</td>
			</tr>
			<tr>
                  <td>MSZP-Párbeszéd <img src="images/mszpparbeszed_logo.png" style="width:60px;height:30px;"></td>
				   <td id="mszp_2018">23.0%</td>
			</tr>
			<tr>
                  <td>LMP <img src="images/lmp_logo.png" style="width:52px;height:30px;"></td>
				   <td id="lmp_2018">3.7%</td>
			</tr>
			<tr>
                  <td>DK <img src="images/dk_logo.png" style="width:34px;height:30px;"></td>
				   <td id="dk_2018">2.5%</td>
			</tr>
			<tr>
