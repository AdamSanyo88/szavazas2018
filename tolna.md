...
<div class="section">
    <div class="row">
		  ...
		  <h5>Tolna</h5>
<br/>
<h5><strong><a id="webURL" href="http://www.valasztas.hu/dyn/onk14/szavossz/hu/M17/T099/tjk.html">2014-es polgármester-választás eredménye</a></strong></h5>
<br/>
<img src="images/2014_onkormanyzat/tolna.png" style="height: 100%; width: 100%; object-fit: contain">
			...
			<table class="striped">
             ...
             <tr>
				   ...
				   <td id="fidesz_mayor">58.9%</td>
				   <td id="fidesz_mayor2">1,915</td>
			</tr>
			<tr>
			<td>Dr. Rubics László - Független</td> 
			<td id="ellenzek_mayor">41.1%</td>
			<td id="ellenzek_mayor2">1,336</td>
			</tr>
              </tbody>
            </table>
<br/>
			...
			<tr>
			 ...
			 <tr>
                  <td>Egyéb szervezet</td>
				   <td id="egyeb_mp">2 *</td><td id="egyeb_mp_lista"></td>
			</tr>
             <tr>
                  <td>Független</td>
...
<p><span id="megjegyzes">* TVE-MCE közös jelölt</span><br/></p>
<br/><h5><strong>2018-as országos listás eredmények</strong></h5><br/><img src="images/listas_charts/tolna.png" style="height: 100%; width: 100%; object-fit: contain"><br/>
			...
			<table class="striped">
             ...
             <tr>
                  <td>Fidesz <img src="images/fideszkdnp_logo.png" style="width:55px;height:30px;"></td>
				   <td id="fidesz_2018">51.4%</td>
			</tr>
			<tr><td>Jobbik <img src="images/jobbik_logo.png" style="width:23px;height:30px;"></td> 
			<td id="jobbik_2018">15.7%</td>
			</tr>
			<tr>
