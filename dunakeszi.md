...
<div class="section">
    <div class="row">
		  ...
		  <h5>Dunakeszi</h5>
<br/>
<h5><strong><a id="webURL" href="http://www.valasztas.hu/dyn/onk14/szavossz/hu/M14/T034/tjk.html">2014-es polgármester-választás eredménye</a></strong></h5>
<br/>
<img src="images/2014_onkormanyzat/dunakeszi.png" style="height: 100%; width: 100%; object-fit: contain">
			...
			<table class="striped">
              ...
              <tbody>
             <tr>
                   <td>Dióssi Csaba - Fidesz-KDNP <img src="images/fideszkdnp_logo.png" style="width:55px;height:30px;"></td>
				   <td id="fidesz_mayor">51.4%</td>
				   <td id="fidesz_mayor2">5,933</td>
			</tr>
			<tr>
			<td>Dr. Horváth István - EGYÜTT-PM-DK-4K!-MLP-MOMA</td> 
			<td id="ellenzek_mayor">24.7%</td>
			<td id="ellenzek_mayor2">2,853</td>
			</tr>
              </tbody>
            </table>
<br/>
...
<br/><h5><strong>2018-as országos listás eredmények</strong></h5><br/><img src="images/listas_charts/dunakeszi.png" style="height: 100%; width: 100%; object-fit: contain"><br/>
