...
<tr>
<td>Ketskeméty-Rády Magdolna -  Együtt <img src="images/egyutt_logo.png" style="width:31px;height:30px;"></td>
<td id="id_egyutt">1.9%</td>
			...
			<h6><strong>Legesélyesebb ellenzéki jelölt: <span id="masodik">MSZP-Párbeszéd/DK, </span><span id="esely2">20%</span><span>-os győzelmi esély</span></strong></h6>
			<br/>
			<h6><strong>Becslés megbízhatósága: Valószínű</strong></h6>
<br/><h6>Megjegyzés a kerülethez: Ez egy nyerhető körzet az ellenzéki jelölt számára, főleg koordináció esetén.</h6>
          </div>
    </div>
</div>
