...
<table class="striped">
			...
			<tr><td>Lukács Attila - Jobbik <img src="images/jobbik_logo.png" style="width:23px;height:30px;"></td><td id="id_jobbik">34.7%</td></tr>
<tr>
                  <td>Kormos Anna - MSZP-Párbeszéd <img src="images/mszpparbeszed_logo.png" style="width:60px;height:30px;"></td>
				  <td id="id_baloldal">10.6%</td>
			</tr>
			<tr>
			...
			<tr>
				  <td>Lengyel Ádám - Momentum <img src="images/momentum_logo.png" style="width:44px;height:30px;"></td>
				  <td id="id_momentum">0.9%</td>
			</tr>
<tr>
<td>Huzsvári Erzsébet -  Együtt <img src="images/egyutt_logo.png" style="width:31px;height:30px;"></td>
...
<br/><h6>Megjegyzés a kerülethez: A Fidesz átlagnál jobb eredménye miatt szinte biztos a Fideszes győzelem.</h6>
          </div>
    </div>
</div>
