...
<div class="section">
    <div class="row">
		  ...
		  <h5>Mohács</h5>
<br/>
<h5><strong><a id="webURL" href="http://www.valasztas.hu/dyn/onk14/szavossz/hu/M02/T181/tjk.html">2014-es polgármester-választás eredménye</a></strong></h5>
<br/>
<img src="images/2014_onkormanyzat/mohacs.png" style="height: 100%; width: 100%; object-fit: contain">
			...
			<table class="striped">
             ...
             <tr>
				   ...
				   <td id="fidesz_mayor">69.7%</td>
				   <td id="fidesz_mayor2">3,375</td>
			</tr>
			<tr>
			<td>Csorbai Ferenc - MSZP <img src="images/mszp2_logo.png" style="width:30px;height:30px;"></td> 
			<td id="ellenzek_mayor">11.7%</td>
			<td id="ellenzek_mayor2">567</td>
			</tr>
              </tbody>
            </table>
<br/>
...
<br/><h5><strong>2018-as országos listás eredmények</strong></h5><br/><img src="images/listas_charts/mohacs.png" style="height: 100%; width: 100%; object-fit: contain"><br/>
