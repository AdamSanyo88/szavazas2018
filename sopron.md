...
<div class="section">
    <div class="row">
		  ...
		  <h5>Sopron</h5>
<br/>
<h5><strong><a id="webURL" href="http://www.valasztas.hu/dyn/onk14/szavossz/hu/M08/T150/tjk.html">2014-es polgármester-választás eredménye</a></strong></h5>
<br/>
<img src="images/2014_onkormanyzat/sopron.png" style="height: 100%; width: 100%; object-fit: contain">
			...
			<table class="striped">
              ...
              <tbody>
             <tr>
                   <td>Dr. Fodor Tamás József - Fidesz-KDNP <img src="images/fideszkdnp_logo.png" style="width:55px;height:30px;"></td>
				   <td id="fidesz_mayor">46.0%</td>
				   <td id="fidesz_mayor2">9,510</td>
			</tr>
			<tr>
			<td>Walter Dezső Péter - Független</td> 
			<td id="ellenzek_mayor">42.9%</td>
			<td id="ellenzek_mayor2">8,876</td>
			</tr>
              </tbody>
            </table>
<br/>
...
<th>Kompenzációs helyek</th>
             ...
             <tr>
                  <td>Fidesz-KDNP <img src="images/fideszkdnp_logo.png" style="width:55px;height:30px;"></td>
				   <td id="fidesz_mp">11</td><td id="fidesz_mp_lista">0</td>
			</tr>
...
<br/><h5><strong>2018-as országos listás eredmények</strong></h5><br/><img src="images/listas_charts/sopron.png" style="height: 100%; width: 100%; object-fit: contain"><br/>
