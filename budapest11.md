---
layout: page
title: Budapest XI. kerület
permalink: /budapest11
---
...
<div class="section">
    <div class="row">
          <div class="col s12">
		  <h5>Budapest XI. kerület</h5>
<br/>
<h5><strong><a id="webURL" href="http://www.valasztas.hu/dyn/onk14/szavossz/hu/M01/T011/tjk.html">2014-es polgármester-választás eredménye</a></strong></h5>
<br/>
<div style="position:relative;width:100%;height:0;padding-top: 68.9%;"><iframe src="https://datastudio.google.com/embed/reporting/1cNSVSA70K2eq3LFj1NolaTdcqjgr9eKE/page/9Pym" frameborder="0" style="position: absolute;width: 100%;/* object-fit: contain; */height: 100%;top: 0;left: 0;right: 0;bottom: 0;" allowfullscreen=""></iframe></div>
			...
			<table class="striped">
             ...
             <tr>
				   ...
				   <td id="fidesz_mayor">46.7%</td>
				   <td id="fidesz_mayor2">25,777</td>
			</tr>
			<tr>
			<td>Molnár Gyula - MSZP <img src="images/mszp2_logo.png" style="width:30px;height:30px;"></td> 
			<td id="ellenzek_mayor">41.4%</td>
			<td id="ellenzek_mayor2">22,878</td>
			</tr>
              </tbody>
            </table>
<br/>
...
<th>Kompenzációs helyek</th>
             ...
             <tr>
                  <td>Fidesz-KDNP <img src="images/fideszkdnp_logo.png" style="width:55px;height:30px;"></td>
				   <td id="fidesz_mp">15</td><td id="fidesz_mp_lista">0</td>
			</tr>
			...
			<tr>
                  <td>MSZP <img src="images/mszp2_logo.png" style="width:30px;height:30px;"></td>
				   <td id="mszp_mp">2 *</td><td id="mszp_mp_lista">4</td>
			</tr>
			<tr>
...
<p><span id="megjegyzes">* MSZP-DK közös jelölt</span><br/></p>
<br/><h5><strong>2018-as országos listás eredmények</strong></h5><br/><img src="images/listas_charts/budapest11.png" style="height: 100%; width: 100%; object-fit: contain"><br/>
			...
			<tr><td>Jobbik <img src="images/jobbik_logo.png" style="width:23px;height:30px;"></td> 
			<td id="jobbik_2018">9.6%</td>
			</tr>
			<tr>
                  <td>MSZP-Párbeszéd <img src="images/mszpparbeszed_logo.png" style="width:60px;height:30px;"></td>
				   <td id="mszp_2018">18.1%</td>
			</tr>
			<tr>
                  <td>LMP <img src="images/lmp_logo.png" style="width:52px;height:30px;"></td>
				   <td id="lmp_2018">12.1%</td>
			</tr>
			<tr>
                  <td>DK <img src="images/dk_logo.png" style="width:34px;height:30px;"></td>
				   <td id="dk_2018">8.2%</td>
			</tr>
			<tr>
