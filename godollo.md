...
<div class="section">
 ...
 <h5><strong>A Fidesz jelöltjének kihívója: Dr. Gémesi György</strong></h5>
<br/>
<table class="striped">
              <thead>
                <tr>
              ...
              <tbody>
             <tr>
                   <td>Kolozs Csaba - Fidesz-KDNP <img src="images/fideszkdnp_logo.png" style="width:55px;height:30px;"></td>
				   <td id="fidesz_mayor">29.8%</td>
			</tr>
			<tr>
			<td>Dr. Gémesi György - Gödöllői Lokálpatrióta Klub</td> 
			<td id="ellenzek_mayor">39.8%</td>
			</tr>
              </tbody>
            </table>
<br/>
<br/>
<h5><strong><a id="webURL" href="https://static.valasztas.hu/dyn/onk14/szavossz/hu/M14/T047/tjk.html">2014-es polgármester-választás eredménye</a></strong></h5><br/>
