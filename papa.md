...
<div class="section">
    <div class="row">
		  ...
		  <h5>Pápa</h5>
<br/>
<h5><strong><a id="webURL" href="http://www.valasztas.hu/dyn/onk14/szavossz/hu/M19/T153/tjk.html">2014-es polgármester-választás eredménye</a></strong></h5>
<br/>
<img src="images/2014_onkormanyzat/papa.png" style="height: 100%; width: 100%; object-fit: contain">
			...
			<table class="striped">
              ...
              <tbody>
             <tr>
                   <td>Dr. Áldozó Tamás Róbert - Fidesz-KDNP <img src="images/fideszkdnp_logo.png" style="width:55px;height:30px;"></td>
				   <td id="fidesz_mayor">47.9%</td>
				   <td id="fidesz_mayor2">4,381</td>
			</tr>
			<tr>
			<td>Grőber Attila - MSZP-EGYÜTT-PM</td> 
			<td id="ellenzek_mayor">31.3%</td>
			<td id="ellenzek_mayor2">2,866</td>
			</tr>
              </tbody>
            </table>
<br/>
...
<br/><h5><strong>2018-as országos listás eredmények</strong></h5><br/><img src="images/listas_charts/papa.png" style="height: 100%; width: 100%; object-fit: contain"><br/>
