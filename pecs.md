...
<div class="section">
    <div class="row">
		  ...
		  <h5>Pécs</h5>
<br/>
<h5><strong><a id="webURL" href="http://www.valasztas.hu/dyn/onk14/szavossz/hu/M02/T217/tjk.html">2014-es polgármester-választás eredménye</a></strong></h5>
<br/>
<img src="images/2014_onkormanyzat/pecs.png" style="height: 100%; width: 100%; object-fit: contain">
			...
			<table class="striped">
              ...
              <tbody>
             <tr>
                   <td>Dr. Páva Zsolt- Fidesz-KDNP <img src="images/fideszkdnp_logo.png" style="width:55px;height:30px;"></td>
				   <td id="fidesz_mayor">39.3%</td>
				   <td id="fidesz_mayor2">16,631</td>
			</tr>
			<tr>
			<td>Cserfainé Dr. Kovács Ágnes Ilona - FORUM-MSZP-EGYÜTT-PM</td> 
			<td id="ellenzek_mayor">28.0%</td>
			<td id="ellenzek_mayor2">11,864</td>
			</tr>
              </tbody>
            </table>
<br/>
...
<th>Kompenzációs helyek</th>
             ...
             <tr>
                  <td>Fidesz-KDNP <img src="images/fideszkdnp_logo.png" style="width:55px;height:30px;"></td>
				   <td id="fidesz_mp">19</td><td id="fidesz_mp_lista">0</td>
			</tr>
			...
			<tr>
			 ...
			 <tr>
                  <td>Egyéb szervezet</td>
				   <td id="egyeb_mp">0</td><td id="egyeb_mp_lista">2</td>
			</tr>
             <tr>
                  <td>Független</td>
...
<br/><h5><strong>2018-as országos listás eredmények</strong></h5><br/><img src="images/listas_charts/pecs.png" style="height: 100%; width: 100%; object-fit: contain"><br/>
