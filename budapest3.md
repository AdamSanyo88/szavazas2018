...
<div class="section">
 ...
 <h5><strong>A Fidesz jelöltjének kihívója: Kiss László  </strong></h5>
<br/>
<table class="striped">
              <thead>
                <tr>
			...
			<tr>
			<td>Kiss László - MOMENTUM-DK-MSZP-PÁRBESZÉD-LMP <img src="images/kozos_ellenzek_logo.png" style="width:180px;height:30px;"></td> 
			<td id="ellenzek_mayor">49.9%</td>
			</tr>
              </tbody>
            </table>
<br/>
<br/>
<h5><strong><a id="webURL" href="https://static.valasztas.hu/dyn/onk14/szavossz/hu/M01/T003/tjk.html">2014-es polgármester-választás eredménye</a></strong></h5><br/>
