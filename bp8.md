...
<table class="striped">
              ...
              <tbody>
             <tr>
                  <td>Jelen Tamás - Fidesz-KDNP <img src="images/fideszkdnp_logo.png" style="width:55px;height:30px;"></td>
...
<tr>
<td>Kratochwill György -  Együtt <img src="images/egyutt_logo.png" style="width:31px;height:30px;"></td>
<td id="id_egyutt">2.2%</td>
			...
			<h6>Legesélyesebb ellenzéki jelölt: <span id="masodik">MSZP-Párbeszéd/DK, </span><span id="esely2">95%</span><span>-os győzelmi esély</span></h6>
			<br/>
			<h6>Becslés megbízhatósága: Biztos</h6>
<br/><h6>Megjegyzés a kerülethez: Stabil baloldali győzelem várható.</h6>
          </div>
    </div>
</div>
