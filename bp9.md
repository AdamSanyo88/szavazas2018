...
<td id="id_egyutt">2.2%</td>
			...
			<h6>Legesélyesebb ellenzéki jelölt: <span id="masodik">MSZP-Párbeszéd/DK, </span><span id="esely2">82%</span><span>-os győzelmi esély</span></h6>
			<br/>
			<h6>Becslés megbízhatósága: Valószínű</h6>
<br/><h6>Megjegyzés a kerülethez: Inkább baloldali kerület, amelyben az átszavazás mértéke dönti majd el, hogy milyen szoros lesz az eredmény.</h6>
          </div>
    </div>
</div>
