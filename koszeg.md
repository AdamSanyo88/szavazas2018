...
<div class="section">
 ...
 <h5><strong>A Fidesz jelöltjének kihívója: Rába Kálmán</strong></h5>
<br/>
<table class="striped">
              <thead>
                <tr>
              ...
              <tbody>
             <tr>
                   <td>Básthy Béla - FIDESZ-KDNP <img src="images/fideszkdnp_logo.png" style="width:55px;height:30px;"></td>
				   <td id="fidesz_mayor">58.3%</td>
			</tr>
			<tr>
			<td>Rába Kálmán - MMM</td> 
			<td id="ellenzek_mayor">29.3%</td>
			</tr>
              </tbody>
            </table>
<br/>
<br/>
<h5><strong><a id="webURL" href="https://static.valasztas.hu/dyn/onk14/szavossz/hu/M18/T096/tjk.html">2014-es polgármester-választás eredménye</a></strong></h5><br/>
