...
<div class="section">
    <div class="row">
		  ...
		  <h5>Ózd</h5>
<br/>
<h5><strong><a id="webURL" href="http://www.valasztas.hu/dyn/onk14/szavossz/hu/M05/T226/tjk.html">2014-es polgármester-választás eredménye</a></strong></h5>
<br/>
<img src="images/2014_onkormanyzat/ozd.png" style="height: 100%; width: 100%; object-fit: contain">
			...
			<table class="striped">
              ...
              <tbody>
             <tr>
                   <td>Fürjes Pál - Fidesz-KDNP <img src="images/fideszkdnp_logo.png" style="width:55px;height:30px;"></td>
				   <td id="fidesz_mayor">31.8%</td>
				   <td id="fidesz_mayor2">5,076</td>
			</tr>
			<tr>
			<td>Janiczak Dávid - Jobbik <img src="images/jobbik_logo.png" style="width:23px;height:30px;"></td> 
			<td id="ellenzek_mayor">64.4%</td>
			<td id="ellenzek_mayor2">10,299</td>
			</tr>
              </tbody>
            </table>
<br/>
...
<th>Kompenzációs helyek</th>
			...
			<tr><td>Jobbik <img src="images/jobbik_logo.png" style="width:23px;height:30px;"></td>
				<td id="jobbik_mp">3</td><td id="jobbik_mp_lista"></td>
			</tr>
			<tr>
...
<br/><h5><strong>2018-as országos listás eredmények</strong></h5><br/><img src="images/listas_charts/ozd.png" style="height: 100%; width: 100%; object-fit: contain"><br/>
