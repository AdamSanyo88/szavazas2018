...
<div class="section">
    <div class="row">
		  ...
		  <h5>Püspökladány</h5>
<br/>
<h5><strong><a id="webURL" href="http://www.valasztas.hu/dyn/onk14/szavossz/hu/M09/T063/tjk.html">2014-es polgármester-választás eredménye</a></strong></h5>
<br/>
<img src="images/2014_onkormanyzat/puspokladany.png" style="height: 100%; width: 100%; object-fit: contain">
			...
			<table class="striped">
              ...
              <tbody>
             <tr>
                   <td>Dombi Imréné - Fidesz-KDNP <img src="images/fideszkdnp_logo.png" style="width:55px;height:30px;"></td>
				   <td id="fidesz_mayor">35.5%</td>
				   <td id="fidesz_mayor2">2,108</td>
			</tr>
			<tr>
			<td>Tóth Lajos - Független</td> 
			<td id="ellenzek_mayor">34.6%</td>
			<td id="ellenzek_mayor2">2,056</td>
			</tr>
              </tbody>
            </table>
<br/>
...
<th>Kompenzációs helyek</th>
             ...
             <tr>
                  <td>Fidesz-KDNP <img src="images/fideszkdnp_logo.png" style="width:55px;height:30px;"></td>
				   <td id="fidesz_mp">5</td><td id="fidesz_mp_lista"></td>
			</tr>
...
<br/><h5><strong>2018-as országos listás eredmények</strong></h5><br/><img src="images/listas_charts/puspokladany.png" style="height: 100%; width: 100%; object-fit: contain"><br/>
