---
layout: page
title: Hajdúböszörmény
permalink: /hajduboszormeny
---
...
<div class="section">
    <div class="row">
          <div class="col s12">
		  <h5>Hajdúböszörmény</h5>
<br/>
<h5><strong><a id="webURL" href="http://www.valasztas.hu/dyn/onk14/szavossz/hu/M09/T030/tjk.html">2014-es polgármester-választás eredménye</a></strong></h5>
<br/>
<img src="images/2014_onkormanyzat/hajduboszormeny.png" style="height: 100%; width: 100%; object-fit: contain">
			...
			<table class="striped">
             ...
             <tr>
				   ...
				   <td id="fidesz_mayor2">4,411</td>
			</tr>
			<tr>
			<td>Nagy Zoltán - Jobbik <img src="images/jobbik_logo.png" style="width:23px;height:30px;"></td> 
			<td id="ellenzek_mayor">30.7%</td>
			<td id="ellenzek_mayor2">2,339</td>
			</tr>
              </tbody>
            </table>
<br/>
...
<br/><h5><strong>2018-as országos listás eredmények</strong></h5><br/><img src="images/listas_charts/hajduboszormeny.png" style="height: 100%; width: 100%; object-fit: contain"><br/>
			...
			<table class="striped">
             ...
             <tr>
                  <td>Fidesz <img src="images/fideszkdnp_logo.png" style="width:55px;height:30px;"></td>
				   <td id="fidesz_2018">50.3%</td>
			</tr>
			<tr><td>Jobbik <img src="images/jobbik_logo.png" style="width:23px;height:30px;"></td> 
			<td id="jobbik_2018">25.1%</td>
			</tr>
			<tr>
