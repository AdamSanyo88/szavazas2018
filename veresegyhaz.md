...
<div class="section">
    <div class="row">
		  ...
		  <h5>Veresegyház</h5>
<br/>
<h5><strong><a id="webURL" href="http://www.valasztas.hu/dyn/onk14/szavossz/hu/M14/T178/tjk.html">2014-es polgármester-választás eredménye</a></strong></h5>
<br/>
<img src="images/2014_onkormanyzat/veresegyhaz.png" style="height: 100%; width: 100%; object-fit: contain">
			...
			<table class="striped">
              ...
              <tbody>
             <tr>
                   <td>Szabóné Tolnai Ildikó - Fidesz-KDNP <img src="images/fideszkdnp_logo.png" style="width:55px;height:30px;"></td>
				   <td id="fidesz_mayor">12.6%</td>
				   <td id="fidesz_mayor2">748</td>
			</tr>
			<tr>
			<td>Pásztor Béla - Független</td> 
			<td id="ellenzek_mayor">87.4%</td>
			<td id="ellenzek_mayor2">5,196</td>
			</tr>
              </tbody>
            </table>
<br/>
			...
			<tr>
			 ...
			 <tr>
                  <td>Egyéb szervezet</td>
				   <td id="egyeb_mp">8 *</td><td id="egyeb_mp_lista"></td>
			</tr>
             <tr>
                  <td>Független</td>
...
<p><span id="megjegyzes">* 7 Szove Egyesület jelölt, 1 ÉVÖGY jelölt</span><br/></p>
<br/><h5><strong>2018-as országos listás eredmények</strong></h5><br/><img src="images/listas_charts/veresegyhaz.png" style="height: 100%; width: 100%; object-fit: contain"><br/>
