---
layout: page
title: Törökszentmiklós
permalink: /torokszentmiklos
---
...
<div class="section">
    <div class="row">
          <div class="col s12">
		  <h5>Törökszentmiklós</h5>
<br/>
<h5><strong><a id="webURL" href="http://www.valasztas.hu/dyn/onk14/szavossz/hu/M11/T073/tjk.html">2014-es polgármester-választás eredménye</a></strong></h5>
<br/>
<img src="images/2014_onkormanyzat/torokszentmiklos.png" style="height: 100%; width: 100%; object-fit: contain">
			...
			<table class="striped">
              ...
              <tbody>
             <tr>
                   <td>Dr. Juhász Enikő Éva - Fidesz-KDNP <img src="images/fideszkdnp_logo.png" style="width:55px;height:30px;"></td>
				   <td id="fidesz_mayor">36.6%</td>
				   <td id="fidesz_mayor2">2,884</td>
			</tr>
			<tr>
			<td>Markót Imre - Jobbik <img src="images/jobbik_logo.png" style="width:23px;height:30px;"></td> 
			<td id="ellenzek_mayor">47.7%</td>
			<td id="ellenzek_mayor2">3,761</td>
			</tr>
              </tbody>
            </table>
<br/>
...
<th>Kompenzációs helyek</th>
			...
			<tr><td>Jobbik <img src="images/jobbik_logo.png" style="width:23px;height:30px;"></td>
				<td id="jobbik_mp">7</td><td id="jobbik_mp_lista"></td>
			</tr>
			<tr>
			...
			<table class="striped">
             ...
             <tr>
                  <td>Fidesz <img src="images/fideszkdnp_logo.png" style="width:55px;height:30px;"></td>
				   <td id="fidesz_2018">42.8%</td>
			</tr>
			<tr><td>Jobbik <img src="images/jobbik_logo.png" style="width:23px;height:30px;"></td> 
			<td id="jobbik_2018">33.8%</td>
			</tr>
			<tr>
                  <td>MSZP-Párbeszéd <img src="images/mszpparbeszed_logo.png" style="width:60px;height:30px;"></td>
				   <td id="mszp_2018">8.9%</td>
			</tr>
			<tr>
                  <td>LMP <img src="images/lmp_logo.png" style="width:52px;height:30px;"></td>
				   <td id="lmp_2018">5.5%</td>
			</tr>
			<tr>
                  <td>DK <img src="images/dk_logo.png" style="width:34px;height:30px;"></td>
				   <td id="dk_2018">3.6%</td>
			</tr>
			<tr>
