...
<div class="section">
    <div class="row">
		  ...
		  <h5>Dunaújváros</h5>
<br/>
<h5><strong><a id="webURL" href="http://www.valasztas.hu/dyn/onk14/szavossz/hu/M07/T024/tjk.html">2014-es polgármester-választás eredménye</a></strong></h5>
<br/>
<img src="images/2014_onkormanyzat/dunaujvaros.png" style="height: 100%; width: 100%; object-fit: contain">
			...
			<table class="striped">
              ...
              <tbody>
             <tr>
                   <td>Cserna Gábor Ferenc - Fidesz-KDNP <img src="images/fideszkdnp_logo.png" style="width:55px;height:30px;"></td>
				   <td id="fidesz_mayor">45.3%</td>
				   <td id="fidesz_mayor2">6,782</td>
			</tr>
			<tr>
			<td>Pintér Attila - MSZP-DK-Együtt</td> 
			<td id="ellenzek_mayor">33.3%</td>
			<td id="ellenzek_mayor2">4,973</td>
			</tr>
              </tbody>
            </table>
<br/>
...
<br/><h5><strong>2018-as országos listás eredmények</strong></h5><br/><img src="images/listas_charts/dunaujvaros.png" style="height: 100%; width: 100%; object-fit: contain"><br/>
