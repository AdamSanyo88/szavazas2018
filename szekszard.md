...
<div class="section">
    <div class="row">
		  ...
		  <h5>Szekszárd</h5>
<br/>
<h5><strong><a id="webURL" href="http://www.valasztas.hu/dyn/onk14/szavossz/hu/M17/T095/tjk.html">2014-es polgármester-választás eredménye</a></strong></h5>
<br/>
<img src="images/2014_onkormanyzat/szekszard.png" style="height: 100%; width: 100%; object-fit: contain">
			...
			<table class="striped">
              ...
              <tbody>
             <tr>
                   <td>Ács Rezső - Fidesz-KDNP <img src="images/fideszkdnp_logo.png" style="width:55px;height:30px;"></td>
				   <td id="fidesz_mayor">46.6%</td>
				   <td id="fidesz_mayor2">5,469</td>
			</tr>
			<tr>
			<td>Dr. Hadházy Ákos Ányos - LMP <img src="images/lmp_logo.png" style="width:52px;height:30px;"></td> 
			<td id="ellenzek_mayor">41.7%</td>
			<td id="ellenzek_mayor2">4,892</td>
			</tr>
              </tbody>
            </table>
<br/>
...
<p><span id="megjegyzes">* MSZP-PM-EGYÜTT-DK közös jelölt</span><br/></p>
<br/><h5><strong>2018-as országos listás eredmények</strong></h5><br/><img src="images/listas_charts/szekszard.png" style="height: 100%; width: 100%; object-fit: contain"><br/>
			...
			<table class="striped">
             ...
             <tr>
                  <td>Fidesz <img src="images/fideszkdnp_logo.png" style="width:55px;height:30px;"></td>
				   <td id="fidesz_2018">46.7%</td>
			</tr>
			<tr><td>Jobbik <img src="images/jobbik_logo.png" style="width:23px;height:30px;"></td> 
			<td id="jobbik_2018">14.2%</td>
			</tr>
			<tr>
