...
<div class="section">
    <div class="row">
		  ...
		  <h5>Pilisvörösvár</h5>
<br/>
<h5><strong><a id="webURL" href="http://www.valasztas.hu/dyn/onk14/szavossz/hu/M14/T112/tjk.html">2014-es polgármester-választás eredménye</a></strong></h5>
<br/>
<img src="images/2014_onkormanyzat/pilisvorosvar.png" style="height: 100%; width: 100%; object-fit: contain">
			...
			<table class="striped">
              ...
              <tbody>
             <tr>
                   <td>Fresz Péter - Fidesz-KDNP <img src="images/fideszkdnp_logo.png" style="width:55px;height:30px;"></td>
				   <td id="fidesz_mayor">33.4%</td>
				   <td id="fidesz_mayor2">1,592</td>
			</tr>
			<tr>
			<td>Gromon István - VKE</td> 
			<td id="ellenzek_mayor">53.1%</td>
			<td id="ellenzek_mayor2">2,528</td>
			</tr>
              </tbody>
            </table>
<br/>
...
<p><span id="megjegyzes">* VKE jelölt</span><br/></p>
<br/><h5><strong>2018-as országos listás eredmények</strong></h5><br/><img src="images/listas_charts/pilisvorosvar.png" style="height: 100%; width: 100%; object-fit: contain"><br/>
