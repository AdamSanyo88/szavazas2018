---
layout: page
title: Budapest XVIII. kerület
permalink: /budapest18
---
...
<div class="section">
    <div class="row">
          <div class="col s12">
		  <h5>Budapest XVIII. kerület</h5>
<br/>
<h5><strong><a id="webURL" href="http://www.valasztas.hu/dyn/onk14/szavossz/hu/M01/T018/tjk.html">2014-es polgármester-választás eredménye</a></strong></h5>
<br/>
<div style="position:relative;width:100%;height:0;padding-top: 68.9%;"><iframe src="https://datastudio.google.com/embed/reporting/1cNSVSA70K2eq3LFj1NolaTdcqjgr9eKE/page/KQym" frameborder="0" style="position: absolute;width: 100%;/* object-fit: contain; */height: 100%;top: 0;left: 0;right: 0;bottom: 0;" allowfullscreen=""></iframe></div>
			...
			<table class="striped">
             ...
             <tr>
				   ...
				   <td id="fidesz_mayor2">15,202</td>
			</tr>
			<tr>
			<td>Szaniszló Sándor <img src="images/mszp2_logo.png" style="width:30px;height:30px;"></td> 
			<td id="ellenzek_mayor">35.2%</td>
			<td id="ellenzek_mayor2">12,342</td>
			</tr>
              </tbody>
            </table>
<br/>
...
<th>Kompenzációs helyek</th>
             ...
             <tr>
                  <td>Fidesz-KDNP <img src="images/fideszkdnp_logo.png" style="width:55px;height:30px;"></td>
				   <td id="fidesz_mp">11</td><td id="fidesz_mp_lista">1</td>
			</tr>
			...
			<tr>
                  <td>MSZP <img src="images/mszp2_logo.png" style="width:30px;height:30px;"></td>
				   <td id="mszp_mp">3 *</td><td id="mszp_mp_lista">3</td>
			</tr>
			<tr>
...
<p><span id="megjegyzes">* MSZP-DK-EGYÜTT-PM-MLP-SZOCIÁLDEMOKRATÁK közös jelölt</span><br/></p>
<br/><h5><strong>2018-as országos listás eredmények</strong></h5><br/><img src="images/listas_charts/budapest18.png" style="height: 100%; width: 100%; object-fit: contain"><br/>
			...
			<table class="striped">
             ...
             <tr>
                  <td>Fidesz <img src="images/fideszkdnp_logo.png" style="width:55px;height:30px;"></td>
				   <td id="fidesz_2018">39.0%</td>
			</tr>
			<tr><td>Jobbik <img src="images/jobbik_logo.png" style="width:23px;height:30px;"></td> 
			<td id="jobbik_2018">16.7%</td>
			</tr>
			<tr>
