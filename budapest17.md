---
layout: page
title: Budapest XVII. kerület
permalink: /budapest17
---
...
<div class="section">
    <div class="row">
          <div class="col s12">
		  <h5>Budapest XVII. kerület</h5>
<br/>
<h5><strong><a id="webURL" href="http://www.valasztas.hu/dyn/onk14/szavossz/hu/M01/T017/tjk.html">2014-es polgármester-választás eredménye</a></strong></h5>
<br/>
<div style="position:relative;width:100%;height:0;padding-top: 68.9%;"><iframe src="https://datastudio.google.com/embed/reporting/1cNSVSA70K2eq3LFj1NolaTdcqjgr9eKE/page/JQym" frameborder="0" style="position: absolute;width: 100%;/* object-fit: contain; */height: 100%;top: 0;left: 0;right: 0;bottom: 0;" allowfullscreen=""></iframe></div>
			...
			<table class="striped">
              ...
              <tbody>
             <tr>
                   <td>Riz Levente Konrád - Fidesz-KDNP <img src="images/fideszkdnp_logo.png" style="width:55px;height:30px;"></td>
				   <td id="fidesz_mayor">64.8%</td>
				   <td id="fidesz_mayor2">18,887</td>
			</tr>
			<tr>
			<td>Gy. Németh Erzsébet - DK <img src="images/dk_logo.png" style="width:34px;height:30px;"></td> 
			<td id="ellenzek_mayor">19.7%</td>
			<td id="ellenzek_mayor2">5,738</td>
			</tr>
              </tbody>
            </table>
<br/>
...
<th>Kompenzációs helyek</th>
             ...
             <tr>
                  <td>Fidesz-KDNP <img src="images/fideszkdnp_logo.png" style="width:55px;height:30px;"></td>
				   <td id="fidesz_mp">14</td><td id="fidesz_mp_lista">0</td>
			</tr>
...
<br/><h5><strong>2018-as országos listás eredmények</strong></h5><br/><img src="images/listas_charts/budapest17.png" style="height: 100%; width: 100%; object-fit: contain"><br/>
