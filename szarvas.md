...
<div class="section">
    <div class="row">
		  ...
		  <h5>Szarvas</h5>
<br/>
<h5><strong><a id="webURL" href="http://www.valasztas.hu/dyn/onk14/szavossz/hu/M04/T066/tjk.html">2014-es polgármester-választás eredménye</a></strong></h5>
<br/>
<img src="images/2014_onkormanyzat/szarvas.png" style="height: 100%; width: 100%; object-fit: contain">
			...
			<table class="striped">
              ...
              <tbody>
             <tr>
                   <td>Babák Mihály - Fidesz-KDNP <img src="images/fideszkdnp_logo.png" style="width:55px;height:30px;"></td>
				   <td id="fidesz_mayor">51.2%</td>
				   <td id="fidesz_mayor2">2,824</td>
			</tr>
			<tr>
			<td>Csanádi László Attila - NACSE</td> 
			<td id="ellenzek_mayor">21.8%</td>
			<td id="ellenzek_mayor2">1,201</td>
			</tr>
              </tbody>
            </table>
<br/>
...
<p><span id="megjegyzes">* NACSE jelölt</span><br/></p>
<br/><h5><strong>2018-as országos listás eredmények</strong></h5><br/><img src="images/listas_charts/szarvas.png" style="height: 100%; width: 100%; object-fit: contain"><br/>
