...
<div class="section">
    <div class="row">
		  ...
		  <h5>Kazincbarcika</h5>
<br/>
<h5><strong><a id="webURL" href="http://www.valasztas.hu/dyn/onk14/szavossz/hu/M05/T153/tjk.html">2014-es polgármester-választás eredménye</a></strong></h5>
<br/>
<img src="images/2014_onkormanyzat/kazincbarcika.png" style="height: 100%; width: 100%; object-fit: contain">
			...
			<table class="striped">
              ...
              <tbody>
             <tr>
                   <td>Kondorné Sztojka Ágnes - Fidesz-KDNP <img src="images/fideszkdnp_logo.png" style="width:55px;height:30px;"></td>
				   <td id="fidesz_mayor">27.0%</td>
				   <td id="fidesz_mayor2">2,363</td>
			</tr>
			<tr>
			<td>Szitka Péter - MSZP-DK-EGYÜTT-PM</td> 
			<td id="ellenzek_mayor">58.9%</td>
			<td id="ellenzek_mayor2">5,151</td>
			</tr>
              </tbody>
            </table>
<br/>
...
<th>Kompenzációs helyek</th>
			...
			<tr>
                  <td>MSZP <img src="images/mszp2_logo.png" style="width:30px;height:30px;"></td>
				   <td id="mszp_mp">10 *</td><td id="mszp_mp_lista"></td>
			</tr>
			<tr>
...
<br/><h5><strong>2018-as országos listás eredmények</strong></h5><br/><img src="images/listas_charts/kazincbarcika.png" style="height: 100%; width: 100%; object-fit: contain"><br/>
