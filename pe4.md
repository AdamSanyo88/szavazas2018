...
<table class="striped">
             ...
             <tr>
                  <td>Rétvári Bence - Fidesz-KDNP <img src="images/fideszkdnp_logo.png" style="width:55px;height:30px;"></td>
				   <td id="id_fidesz">47.8% &emsp; <span id="id_fidesz2">(48.3%)</span></td>
			</tr>
			<tr><td>Fehér Zsolt - Jobbik <img src="images/jobbik_logo.png" style="width:23px;height:30px;"></td> <td id="id_jobbik">20.8% &emsp; <span id="id_jobbik2">(25.7%)</span></td></tr>
<tr>
                  <td>Krauze István - DK <img src="images/dk_logo.png" style="width:34px;height:30px;"></td>
				   <td id="id_baloldal">19.2% &emsp; <span id="id_baloldal2">(19.1%)</span></td>
			</tr>
			<tr>
                  <td>Matkovich Ilona - LMP <img src="images/lmp_logo.png" style="width:52px;height:30px;"></td>
				   <td id="id_lmp">7.2% &emsp; <span id="id_lmp2">(4.4%)</span></td>
			</tr>
			<tr>
				  <td>Juhász Béla Róbert - Momentum <img src="images/momentum_logo.png" style="width:44px;height:30px;"></td>
				   <td id="id_momentum">2.5% &emsp; <span id="id_momentum2">(1.5%)</span></td>
			</tr>
<tr>
<td>dr. Jakab Zoltán Attila -  Együtt <img src="images/egyutt_logo2.png" style="width:71px;height:30px;"></td>
 <td id="id_egyutt">1.7% &emsp; <span id="id_egyutt2">(1.0%)</span></td>
</tr>                
              </tbody>
