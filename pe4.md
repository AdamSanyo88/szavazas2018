...
<br/>
<h6><strong>Legfrissebb 2018-as becslések eredménye (átszavazással):</strong></h6><br/><img src="images/vk_charts/pe4.png" style="height: 100%; width: 100%; object-fit: contain"><br/>
			<h5><strong>Legesélyesebb ellenzéki jelölt: <span id="masodik">Fehér Zsolt (Jobbik)</span><span id="esely2"></span><span></span></strong></h5>
<h5><strong><a href="https://rendszervaltas2018.hu">Márki-Zay Péter ajánlása</a>: xx </strong></h5>
<table class="striped">
              <thead>
                <tr>
                    <th>Jelöltek</th>
             ...
             <tr>
				  ...
				  <td id="id_fidesz">48.1% <span id="id_fidesz2">(48.6%)</span></td>
			</tr>
			<tr><td>Fehér Zsolt - Jobbik <img src="images/jobbik_logo.png" style="width:23px;height:30px;"></td><td id="id_jobbik">20.9% <span id="id_jobbik2">(25.2%)</span></td></tr>
<tr>
                  <td>Krauze István - DK <img src="images/dk_logo.png" style="width:34px;height:30px;"></td>
				  <td id="id_baloldal">19.4% <span id="id_baloldal2">(19.2%)</span></td>
			</tr>
			<tr>
                  <td>Matkovich Ilona - LMP <img src="images/lmp_logo.png" style="width:52px;height:30px;"></td>
				  <td id="lmp">7.3% <span id="id_lmp2">(4.4%)</span></td>
			</tr>
			<tr>
				  <td>Juhász Béla Róbert - Momentum <img src="images/momentum_logo.png" style="width:44px;height:30px;"></td>
				  <td id="id_momentum">2.6% <span id="id_momentum2">(1.5%)</span></td>
			</tr>
<tr>
<td>dr. Jakab Zoltán Attila -  Együtt <img src="images/egyutt_logo2.png" style="width:71px;height:30px;"></td>
<td id="id_egyutt">1.7% <span id="id_egyutt2">(1.0%)</span></td>
</tr>                
              </tbody>
