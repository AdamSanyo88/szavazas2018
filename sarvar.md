...
<div class="section">
    <div class="row">
		  ...
		  <h5>Sárvár</h5>
<br/>
<h5><strong><a id="webURL" href="http://www.valasztas.hu/dyn/onk14/szavossz/hu/M18/T167/tjk.html">2014-es polgármester-választás eredménye</a></strong></h5>
<br/>
<img src="images/2014_onkormanyzat/sarvar.png" style="height: 100%; width: 100%; object-fit: contain">
			...
			<table class="striped">
             ...
             <tr>
				   ...
				   <td id="fidesz_mayor2">3,330</td>
			</tr>
			<tr>
			<td>Szabó Lajos - MSZP-1099-1</td> 
			<td id="ellenzek_mayor">24.6%</td>
			<td id="ellenzek_mayor2">1,182</td>
			</tr>
              </tbody>
            </table>
<br/>
...
<p><span id="megjegyzes">* MSZP-1099-1 közös jelölt</span><br/></p>
<br/><h5><strong>2018-as országos listás eredmények</strong></h5><br/><img src="images/listas_charts/sarvar.png" style="height: 100%; width: 100%; object-fit: contain"><br/>
			...
			<tr>
                  <td>LMP <img src="images/lmp_logo.png" style="width:52px;height:30px;"></td>
				   <td id="lmp_2018">8.7%</td>
			</tr>
			<tr>
                  <td>DK <img src="images/dk_logo.png" style="width:34px;height:30px;"></td>
				   <td id="dk_2018">3.3%</td>
			</tr>
			<tr>
