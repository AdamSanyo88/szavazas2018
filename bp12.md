...
<table class="striped">
             ...
             <tr>
                  <td>László Tamás - Fidesz-KDNP <img src="images/fideszkdnp_logo.png" style="width:55px;height:30px;"></td>
				   <td id="id_fidesz">36.6% &emsp; <span id="id_fidesz2">(37.40%)</span></td>
			</tr>
			<tr><td>Dr. Gyenes Géza - Jobbik <img src="images/jobbik_logo.png" style="width:23px;height:30px;"></td> <td id="id_jobbik">14.7% &emsp; <span id="id_jobbik2">(10.5%)</span></td></tr>
<tr>
                  <td>Hajdu László - DK <img src="images/dk_logo.png" style="width:34px;height:30px;"></td>
				   <td id="id_baloldal">27.5% &emsp; <span id="id_baloldal2">(39.45%)</span></td>
			</tr>
			<tr>
                  <td>Szilvágyi László - LMP <img src="images/lmp_logo.png" style="width:52px;height:30px;"></td>
				   <td id="id_lmp">10.7% &emsp; <span id="id_lmp2">(6.0%)</span></td>
			</tr>
			<tr>
				  <td>Krisztics Bianka Ilona - Momentum <img src="images/momentum_logo.png" style="width:44px;height:30px;"></td>
				   <td id="id_momentum">4.7% &emsp; <span id="id_momentum2">(2.7%)</span></td>
			</tr>
<tr>
<td>Huzsvári Erzsébet Mária - Együtt <img src="images/egyutt_logo2.png" style="width:71px;height:30px;"></td>
 <td id="id_egyutt">3.5% &emsp; <span id="id_egyutt2">(2.1%)</span></td>
</tr>            
<tr>
