---
layout: page
title: Budapest XVI. kerület
permalink: /budapest16
---
...
<div class="section">
    <div class="row">
          <div class="col s12">
		  <h5>Budapest XVI. kerület</h5>
<br/>
<h5><strong><a id="webURL" href="http://www.valasztas.hu/dyn/onk14/szavossz/hu/M01/T016/tjk.html">2014-es polgármester-választás eredménye</a></strong></h5>
<br/>
<div style="position:relative;width:100%;height:0;padding-top: 68.9%;"><iframe src="https://datastudio.google.com/embed/reporting/1cNSVSA70K2eq3LFj1NolaTdcqjgr9eKE/page/IQym" frameborder="0" style="position: absolute;width: 100%;/* object-fit: contain; */height: 100%;top: 0;left: 0;right: 0;bottom: 0;" allowfullscreen=""></iframe></div>
			...
			<table class="striped">
             ...
             <tr>
				   ...
				   <td id="fidesz_mayor">60.5%</td>
				   <td id="fidesz_mayor2">16,064</td>
			</tr>
			<tr>
			<td>Abonyi János - MSZP <img src="images/mszp2_logo.png" style="width:30px;height:30px;"></td> 
			<td id="ellenzek_mayor">9.7%</td>
			<td id="ellenzek_mayor2">2,578</td>
			</tr>
              </tbody>
            </table>
<br/>
...
<br/><h5><strong>2018-as országos listás eredmények</strong></h5><br/><img src="images/listas_charts/budapest16.png" style="height: 100%; width: 100%; object-fit: contain"><br/>
			...
			<table class="striped">
             ...
             <tr>
                  <td>Fidesz <img src="images/fideszkdnp_logo.png" style="width:55px;height:30px;"></td>
				   <td id="fidesz_2018">41.4%</td>
			</tr>
			<tr><td>Jobbik <img src="images/jobbik_logo.png" style="width:23px;height:30px;"></td> 
			<td id="jobbik_2018">13.1%</td>
			</tr>
			<tr>
                  <td>MSZP-Párbeszéd <img src="images/mszpparbeszed_logo.png" style="width:60px;height:30px;"></td>
				   <td id="mszp_2018">15.8%</td>
			</tr>
			<tr>
                  <td>LMP <img src="images/lmp_logo.png" style="width:52px;height:30px;"></td>
				   <td id="lmp_2018">10.7%</td>
			</tr>
			<tr>
                  <td>DK <img src="images/dk_logo.png" style="width:34px;height:30px;"></td>
