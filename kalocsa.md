...
<div class="section">
 ...
 <h5><strong>A Fidesz jelöltjének kihívója: Bolvári Ferdinánd</strong></h5>
<br/>
<table class="striped">
              <thead>
                <tr>
              ...
              <tbody>
             <tr>
                   <td>Dr. Filvig Géza - FIDESZ-KDNP-KJE <img src="images/fideszkdnp_logo.png" style="width:55px;height:30px;"></td>
				   <td id="fidesz_mayor">36.6%</td>
			</tr>
			<tr>
			<td>Bolvári Ferdinánd - B-KE</td> 
			<td id="ellenzek_mayor">43.3%</td>
			</tr>
              </tbody>
            </table>
<br/>
<br/>
<h5><strong><a id="webURL" href="https://static.valasztas.hu/dyn/onk14/szavossz/hu/M03/T056/tjk.html">2014-es polgármester-választás eredménye</a></strong></h5><br/>
