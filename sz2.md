...
<table class="striped">
			...
			<tr><td>Budai Lóránt - Jobbik <img src="images/jobbik_logo.png" style="width:23px;height:30px;"></td><td id="id_jobbik">38.7%</td></tr>
<tr>
...
<td id="id_egyutt">0.5%</td>
			...
			<h6><strong>Legesélyesebb ellenzéki jelölt: <span id="masodik">Jobbik, </span><span id="esely2">7%</span><span>-os győzelmi esély</span></strong></h6>
			<br/>
			<h6><strong>Becslés megbízhatósága: Valószínű</strong></h6>
<br/><h6>Megjegyzés a kerülethez: A Jobbik megközelítheti a Fideszt a körzetben, főleg magasabb átszavazási hajlandóság esetén.</h6>
          </div>
    </div>
</div>
