...
<div class="section">
    <div class="row">
		  ...
		  <h5>Kapuvár</h5>
<br/>
<h5><strong><a id="webURL" href="http://www.valasztas.hu/dyn/onk14/szavossz/hu/M08/T081/tjk.html">2014-es polgármester-választás eredménye</a></strong></h5>
<br/>
<img src="images/2014_onkormanyzat/kapuvar.png" style="height: 100%; width: 100%; object-fit: contain">
			...
			<table class="striped">
              ...
              <tbody>
             <tr>
                   <td>Hámori György - Fidesz-KDNP <img src="images/fideszkdnp_logo.png" style="width:55px;height:30px;"></td>
				   <td id="fidesz_mayor">78.3%</td>
				   <td id="fidesz_mayor2">2,722</td>
			</tr>
			<tr>
			<td>Csákány Annamária - Jobbik <img src="images/jobbik_logo.png" style="width:23px;height:30px;"></td> 
			<td id="ellenzek_mayor">21.7%</td>
			<td id="ellenzek_mayor2">753</td>
			</tr>
              </tbody>
            </table>
<br/>
...
<br/><h5><strong>2018-as országos listás eredmények</strong></h5><br/><img src="images/listas_charts/kapuvar.png" style="height: 100%; width: 100%; object-fit: contain"><br/>
