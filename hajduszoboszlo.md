---
layout: page
title: Hajdúszoboszló
permalink: /hajduszoboszlo
---
...
<div class="section">
    <div class="row">
          <div class="col s12">
		  <h5>Hajdúszoboszló</h5>
<br/>
<h5><strong><a id="webURL" href="http://www.valasztas.hu/dyn/onk14/szavossz/hu/M09/T035/tjk.html">2014-es polgármester-választás eredménye</a></strong></h5>
<br/>
<img src="images/2014_onkormanyzat/hajduszoboszlo.png" style="height: 100%; width: 100%; object-fit: contain">
			...
			<table class="striped">
              ...
              <tbody>
             <tr>
                   <td>Dr. Györgyi Zoltán - Fidesz-KDNP <img src="images/fideszkdnp_logo.png" style="width:55px;height:30px;"></td>
...
<th>Kompenzációs helyek</th>
             ...
             <tr>
                  <td>Fidesz-KDNP <img src="images/fideszkdnp_logo.png" style="width:55px;height:30px;"></td>
				   <td id="fidesz_mp">1</td><td id="fidesz_mp_lista"></td>
			</tr>
			...
			<tr>
			 ...
			 <tr>
                  <td>Egyéb szervezet</td>
				   <td id="egyeb_mp">6 *</td><td id="egyeb_mp_lista"></td>
			</tr>
             <tr>
                  <td>Független</td>
...
<p><span id="megjegyzes">* Összefogás Hszob jelölt</span><br/></p>
<br/><h5><strong>2018-as országos listás eredmények</strong></h5><br/><img src="images/listas_charts/hajduszoboszlo.png" style="height: 100%; width: 100%; object-fit: contain"><br/>
			...
			<tr><td>Jobbik <img src="images/jobbik_logo.png" style="width:23px;height:30px;"></td> 
			<td id="jobbik_2018">22.7%</td>
			</tr>
			<tr>
                  <td>MSZP-Párbeszéd <img src="images/mszpparbeszed_logo.png" style="width:60px;height:30px;"></td>
				   <td id="mszp_2018">12.8%</td>
			</tr>
			<tr>
                  <td>LMP <img src="images/lmp_logo.png" style="width:52px;height:30px;"></td>
				   <td id="lmp_2018">7.0%</td>
			</tr>
			<tr>
                  <td>DK <img src="images/dk_logo.png" style="width:34px;height:30px;"></td>
				   <td id="dk_2018">3.7%</td>
			</tr>
			<tr>
