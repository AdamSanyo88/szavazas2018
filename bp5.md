    ...
    <div class="row">
		  ...
		  <h5>Budapest 5-ös választókerület (VII. kerület)</h5>
            <table class="responsive-table">
              ...
              <tbody>
             <tr>
                  <td>Bajkai István - Fidesz</td>
				  <td id="id_fidesz">43.2% </td>
			</tr>
			<tr><td>Stummer János - Jobbik</td><td id="id_jobbik">2.6% </td></tr>
<tr>
                  <td>Oláh Lajos - DK</td>
				  <td id="id_baloldal">48.6% </td>
			</tr>
			<tr>
                  <td>LMP</td>
				  <td id="lmp">3.4% </td>
...
<td id="egyutt">0.0% </td>
			...
			<h5>Várható győztes: <span id="gyoztes">Baloldal, </span><span id="esely">82.5% </span><span>%-os győzelmi esély</span></h5>
			<h6>Legesélyesebb ellenzéki jelölt: <span id="masodik">Fidesz, </span><span id="esely2">17.5% </span><span>%-os győzelmi esély</span></h6>
			<br/>
