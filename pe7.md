...
<td id="id_egyutt">1.8%</td>
			...
			<h6>Legesélyesebb ellenzéki jelölt: <span id="masodik">MSZP-Párbeszéd/DK, </span><span id="esely2">3%</span><span>-os győzelmi esély</span></h6>
			<br/>
			<h6>Becslés megbízhatósága: A jelenleg stabil Fideszes többség elég lehet a győzelemhez (de ellenzéki koordináció esetén szoros eredmény várható).</h6>
