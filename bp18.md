...
<div class="section">
    <div class="row">
		  ...
		  <h5>Budapest 18-as választókerület (XXII. kerület)</h5>
			...
			<tr><td>Dr. Staudt Gábor - Jobbik</td><td id="id_jobbik">3.0%</td></tr>
<tr>
                  <td>Baloldal</td>
...
<td id="egyutt">0.0%</td>
			...
			<h5>Várható győztes: <span id="gyoztes">Fidesz</span><span id="esely">68.0%</span><span>%-os győzelmi esély</span></h5>
			<h6>Legesélyesebb ellenzéki jelölt: <span id="masodik">Baloldal</span><span id="esely2">32.0%</span><span>%-os győzelmi esély</span></h6>
			<br/>
