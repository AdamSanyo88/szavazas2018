...
<div class="section">
    <div class="row">
          <div class="col s12">
		  <h5>Sátoraljaújhely</h5>
<br/>
<h5><strong><a id="webURL" href="http://www.valasztas.hu/dyn/onk14/szavossz/hu/M05/T276/tjk.html">2014-es polgármester-választás eredménye</a></strong></h5>
<br/>
<img src="images/2014_onkormanyzat/satoraljaujhely.png" style="height: 100%; width: 100%; object-fit: contain">
			...
			<table class="striped">
             ...
             <tr>
				   ...
				   <td id="fidesz_mayor">72.3%</td>
				   <td id="fidesz_mayor2">3,522</td>
			</tr>
			<tr>
			<td>Pasztorniczky István - Jobbik <img src="images/jobbik_logo.png" style="width:23px;height:30px;"></td> 
			<td id="ellenzek_mayor">14.5%</td>
			<td id="ellenzek_mayor2">707</td>
			</tr>
              </tbody>
            </table>
<br/>
...
<br/><h5><strong>2018-as országos listás eredmények</strong></h5><br/><img src="images/listas_charts/satoraljaujhely.png" style="height: 100%; width: 100%; object-fit: contain"><br/>
			...
			<table class="striped">
             ...
             <tr>
                  <td>Fidesz <img src="images/fideszkdnp_logo.png" style="width:55px;height:30px;"></td>
				   <td id="fidesz_2018">41.8%</td>
			</tr>
			<tr><td>Jobbik <img src="images/jobbik_logo.png" style="width:23px;height:30px;"></td> 
			<td id="jobbik_2018">26.0%</td>
			</tr>
			<tr>
