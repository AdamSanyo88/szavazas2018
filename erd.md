...
<div class="section">
 ...
 <h5><strong>A Fidesz jelöltjének kihívója: Csőzik László</strong></h5>
<br/>
<table class="striped">
              <thead>
                <tr>
              ...
              <tbody>
             <tr>
                   <td>T. Mészáros András József - FIDESZ-KDNP-ÖSSZEFOGÁS <img src="images/fideszkdnp_logo.png" style="width:55px;height:30px;"></td>
				   <td id="fidesz_mayor">53.0%</td>
			</tr>
			<tr>
			<td>Csőzik László - LMP-JOBBIK-DK-MSZP-CÉL-MOMENTUM-MMM-PÁRBESZÉD-MLP</td> 
			<td id="ellenzek_mayor">44.0%</td>
			</tr>
              </tbody>
            </table>
<br/>
<br/>
<h5><strong><a id="webURL" href="https://static.valasztas.hu/dyn/onk14/szavossz/hu/M14/T038/tjk.html">2014-es polgármester-választás eredménye</a></strong></h5><br/>
