...
<td id="id_mkkp">1.1% <span id="id_mkkp2">(0.9%)</span></td>
            ...
            </table><h5>Várható győztes: <span id="gyoztes">Együtt</span><span id="esely"></span><span></span></h5>
...
<br/><h6><strong>Becslés megbízhatósága a legesélyesebb jelöltről:</strong> <strong><span id="biztos_jelolt">Az Együtt jelöltje az esélyes (koordináció esetén)</span></strong></h6>
