...
<table class="striped">
             ...
             <tr>
                  <td>Németh Szilárd István - Fidesz-KDNP <img src="images/fideszkdnp_logo.png" style="width:55px;height:30px;"></td>
				   <td id="id_fidesz">30.9% &emsp; <span id="id_fidesz2">(33.5%)</span></td>
			</tr>
			<tr><td>Bereczki Miklós - Jobbik <img src="images/jobbik_logo.png" style="width:23px;height:30px;"></td> <td id="id_jobbik">15.7% &emsp; <span id="id_jobbik2">(12.8%)</span></td></tr>
<tr>
                  <td>Bangóné Borbély Ildikó - MSZP-Párbeszéd <img src="images/mszpparbeszed_logo.png" style="width:60px;height:30px;"></td>
				   <td id="id_baloldal">26.6% &emsp; <span id="id_baloldal2">(19.9%)</span></td>
			</tr>
			<tr>
                  <td>dr. Tenk András - LMP <img src="images/lmp_logo.png" style="width:52px;height:30px;"></td>
				   <td id="id_lmp">8.8% &emsp; <span id="id_lmp2">(5.7%)</span></td>
			</tr>
<tr>
<td>dr. Szabó Szabolcs -  Együtt <img src="images/egyutt_logo2.png" style="width:71px;height:30px;"></td>
 <td id="id_egyutt">9.7% &emsp; <span id="id_egyutt2">(26.3%)</span></td>
</tr>            
<tr>
