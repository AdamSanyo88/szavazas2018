...
<div class="section">
    <div class="row">
		  ...
		  <h5>Nagyatád</h5>
<br/>
<h5><strong><a id="webURL" href="http://www.valasztas.hu/dyn/onk14/szavossz/hu/M15/T130/tjk.html">2014-es polgármester-választás eredménye</a></strong></h5>
<br/>
<img src="images/2014_onkormanyzat/nagyatad.png" style="height: 100%; width: 100%; object-fit: contain">
			...
			<table class="striped">
              ...
              <tbody>
             <tr>
                   <td>Kárpáti László Miklós - Fidesz-KDNP <img src="images/fideszkdnp_logo.png" style="width:55px;height:30px;"></td>
				   <td id="fidesz_mayor">36.8%</td>
				   <td id="fidesz_mayor2">1,586</td>
			</tr>
			<tr>
			<td>Ormai István - Nagyatádért</td> 
			<td id="ellenzek_mayor">44.4%</td>
			<td id="ellenzek_mayor2">1,916</td>
			</tr>
              </tbody>
            </table>
<br/>
...
<th>Kompenzációs helyek</th>
             ...
             <tr>
                  <td>Fidesz-KDNP <img src="images/fideszkdnp_logo.png" style="width:55px;height:30px;"></td>
				   <td id="fidesz_mp">2</td><td id="fidesz_mp_lista"></td>
			</tr>
			...
			<tr>
			 ...
			 <tr>
                  <td>Egyéb szervezet</td>
				   <td id="egyeb_mp">4 *</td><td id="egyeb_mp_lista"></td>
			</tr>
             <tr>
                  <td>Független</td>
				   <td id="fuggetlen_mp">2</td><td id="fuggetlen_mp_lista"></td>
			</tr>
   
              </tbody>
            </table>

<p><span id="megjegyzes">* Nagyatádért jelölt</span><br/></p>
<br/><h5><strong>2018-as országos listás eredmények</strong></h5><br/><img src="images/listas_charts/nagyatad.png" style="height: 100%; width: 100%; object-fit: contain"><br/>
