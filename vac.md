...
<div class="section">
    <div class="row">
		  ...
		  <h5>Vác</h5>
<br/>
<h5><strong><a id="webURL" href="http://www.valasztas.hu/dyn/onk14/szavossz/hu/M14/T169/tjk.html">2014-es polgármester-választás eredménye</a></strong></h5>
<br/>
<img src="images/2014_onkormanyzat/vac.png" style="height: 100%; width: 100%; object-fit: contain">
			...
			<table class="striped">
              ...
              <tbody>
             <tr>
                   <td>Fördős József Attila - Fidesz-KDNP <img src="images/fideszkdnp_logo.png" style="width:55px;height:30px;"></td>
				   <td id="fidesz_mayor">40.8%</td>
				   <td id="fidesz_mayor2">4,951</td>
			</tr>
			<tr>
			<td>Dr. Bóth János István - MSZP-DK <img src="images/mszp2_logo.png" style="width:30px;height:30px;"> <img src="images/dk_logo.png" style="width:34px;height:30px;"></td> 
			<td id="ellenzek_mayor">25.7%</td>
			<td id="ellenzek_mayor2">3,118</td>
			</tr>
              </tbody>
            </table>
<br/>
...
<th>Kompenzációs helyek</th>
             ...
             <tr>
                  <td>Fidesz-KDNP <img src="images/fideszkdnp_logo.png" style="width:55px;height:30px;"></td>
				   <td id="fidesz_mp">8</td><td id="fidesz_mp_lista"></td>
			</tr>
...
<br/><h5><strong>2018-as országos listás eredmények</strong></h5><br/><img src="images/listas_charts/vac.png" style="height: 100%; width: 100%; object-fit: contain"><br/>
