...
<div class="section">
 ...
 <h5><strong>A Fidesz jelöltjének kihívója: Matkovich Ilona </strong></h5>
<br/>
<table class="striped">
              <thead>
                <tr>
              ...
              <tbody>
             <tr>
                   <td>Fördős Attila - Fidesz-KDNP <img src="images/fideszkdnp_logo.png" style="width:55px;height:30px;"></td>
				   <td id="fidesz_mayor">51.8%</td>
			</tr>
			<tr>
			<td>Matkovich Ilona - MOMENTUM-DK-Vácért Lokálpatrióta Egyesület-JOBBIK-LMP-Szavad Egyesület-MMM-MSZP-PÁRBESZÉD</td> 
			<td id="ellenzek_mayor">38.4%</td>
			</tr>
              </tbody>
            </table>
<br/>
<h5><strong><a id="webURL" href="https://static.valasztas.hu/dyn/onk14/szavossz/hu/M14/T169/tjk.html">2014-es polgármester-választás eredménye</a></strong></h5><br/>
