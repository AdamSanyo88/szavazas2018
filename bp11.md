...
<div class="section">
    <div class="row">
		  ...
		  <h5>Budapest 11-es választókerület (IV. kerület)</h5>
			...
			<tr><td>Hegedűs Lorántné - Jobbik</td><td id="id_jobbik">3.2%</td></tr>
<tr>
                  <td>Varju László - DK</td>
				  <td id="id_baloldal">50.9%</td>
			</tr>
			<tr>
                  <td>LMP</td>
				  <td id="lmp">2.7%</td>
...
<td id="egyutt">0.0%</td>
			...
			<h5>Várható győztes: <span id="gyoztes">Baloldal</span><span id="esely">94.9%</span><span>%-os győzelmi esély</span></h5>
			<h6>Legesélyesebb ellenzéki jelölt: <span id="masodik">Fidesz</span><span id="esely2">5.1%</span><span>%-os győzelmi esély</span></h6>
			<br/>
