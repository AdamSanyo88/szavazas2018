...
<table class="striped">
			...
			<tr><td>Szabó Zoltán Ferenc - Jobbik <img src="images/jobbik_logo.png" style="width:23px;height:30px;"></td><td id="id_jobbik">31.6%</td></tr>
<tr>
                  <td>Eörsi Mátyás - DK <img src="images/dk_logo.png" style="width:34px;height:30px;"></td>
				  <td id="id_baloldal">13.8%</td>
			</tr>
			<tr>
			...
			<tr>
				  <td>Csányi Balázs - Momentum <img src="images/momentum_logo.png" style="width:44px;height:30px;"></td>
...
<br/><h6>Megjegyzés a kerülethez: A Jobbik az esélyesebb kihívó, de a Fidesz átlag fölötti támogatottsága valószínűleg elég lesz a győzelemhez.</h6>
          </div>
    </div>
</div>
