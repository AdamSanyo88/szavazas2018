...
<div class="section">
    <div class="row">
		  ...
		  <h5>Bonyhád</h5>
<br/>
<h5><strong><a id="webURL" href="http://www.valasztas.hu/dyn/onk14/szavossz/hu/M17/T011/tjk.html">2014-es polgármester-választás eredménye</a></strong></h5>
<br/>
<img src="images/2014_onkormanyzat/bonyhad.png" style="height: 100%; width: 100%; object-fit: contain">
			...
			<table class="striped">
              ...
              <tbody>
             <tr>
                   <td>Filóné Ferencz Ibolya Gyöngyi - Fidesz-KDNP <img src="images/fideszkdnp_logo.png" style="width:55px;height:30px;"></td>
				   <td id="fidesz_mayor">51.9%</td>
				   <td id="fidesz_mayor2">2,322</td>
			</tr>
			<tr>
			<td>Szabó Gábor Tamás - MSZP-DK <img src="images/mszp2_logo.png" style="width:30px;height:30px;"> <img src="images/dk_logo.png" style="width:34px;height:30px;"></td> 
			<td id="ellenzek_mayor">38.5%</td>
			<td id="ellenzek_mayor2">1,720</td>
			</tr>
              </tbody>
            </table>
<br/>
...
<th>Kompenzációs helyek</th>
             ...
             <tr>
                  <td>Fidesz-KDNP <img src="images/fideszkdnp_logo.png" style="width:55px;height:30px;"></td>
				   <td id="fidesz_mp">7</td><td id="fidesz_mp_lista"></td>
			</tr>
			...
			<tr>
                  <td>MSZP <img src="images/mszp2_logo.png" style="width:30px;height:30px;"></td>
				   <td id="mszp_mp">0</td><td id="mszp_mp_lista"></td>
			</tr>
			<tr>
			...
			<tr>
                  <td>Együtt-PM <img src="images/egyutt_pm_logo.png" style="width:42px;height:30px;"></td>
				   <td id="egyutt_mp">0</td><td id="egyutt_mp_lista"></td>
			</tr>
			 <tr>
             ...
             <tr>
                  <td>Független</td>
				   <td id="fuggetlen_mp">1</td><td id="fuggetlen_mp_lista"></td>
			</tr>
...
<br/><h5><strong>2018-as országos listás eredmények</strong></h5><br/><img src="images/listas_charts/bonyhad.png" style="height: 100%; width: 100%; object-fit: contain"><br/>
