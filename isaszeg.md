...
<div class="section">
 ...
 <h5><strong>A Fidesz jelöltjének kihívója: Hatvani Miklós</strong></h5>
<br/>
<table class="striped">
              <thead>
                <tr>
              ...
              <tbody>
             <tr>
                   <td>Bajusz Dániel - Fidesz-KDNP <img src="images/fideszkdnp_logo.png" style="width:55px;height:30px;"></td>
				   <td id="fidesz_mayor">xx%</td>
			</tr>
			<tr>
			<td>Hatvani Miklós - Isaszegi Április 6. Kör</td> 
...
<br/>
<br/>
<h5><strong><a id="webURL" href="https://static.valasztas.hu/dyn/onk14/szavossz/hu/M14/T058/tjk.html">2014-es polgármester-választás eredménye</a></strong></h5><br/>
