...
<div class="section">
    <div class="row">
          <div class="col s12">
		  <h5>Budapest V. kerület</h5>
<br/>
<h5><strong><a id="webURL" href="http://www.valasztas.hu/dyn/onk14/szavossz/hu/M01/T005/tjk.html">2014-es polgármester-választás eredménye</a></strong></h5>
<br/>
<iframe src="https://datastudio.google.com/embed/reporting/1cNSVSA70K2eq3LFj1NolaTdcqjgr9eKE/page/zPym" frameborder="0" style="border:0" allowfullscreen style="height: 80vh; width: 100vh; object-fit: contain"></iframe>
			...
			<table class="striped">
              ...
              <tbody>
             <tr>
                   <td>Szentgyörgyvölgyi Péter - Fidesz-KDNP <img src="images/fideszkdnp_logo.png" style="width:55px;height:30px;"></td>
				   <td id="fidesz_mayor">54.5%</td>
				   <td id="fidesz_mayor2">5,621</td>
			</tr>
			<tr>
			<td>Juhász Péter - Együtt-PM <img src="images/egyutt_pm_logo.png" style="width:42px;height:30px;"></td> 
			<td id="ellenzek_mayor">30.3%</td>
			<td id="ellenzek_mayor2">3,120</td>
			</tr>
              </tbody>
            </table>
<br/>
...
<th>Kompenzációs helyek</th>
             ...
             <tr>
                  <td>Fidesz-KDNP <img src="images/fideszkdnp_logo.png" style="width:55px;height:30px;"></td>
				   <td id="fidesz_mp">10</td><td id="fidesz_mp_lista">0</td>
			</tr>
			...
			<tr>
                  <td>Együtt-PM <img src="images/egyutt_pm_logo.png" style="width:42px;height:30px;"></td>
				   <td id="egyutt_mp">0</td><td id="egyutt_mp_lista">2</td>
			</tr>
			 <tr>
...
<br/><h5><strong>2018-as országos listás eredmények</strong></h5><br/><img src="images/listas_charts/budapest5.png" style="height: 100%; width: 100%; object-fit: contain"><br/>
