...
<div class="section">
 ...
 <h5><strong>A Fidesz jelöltjének kihívója: Hegyesi Adrien Beáta </strong></h5>
<br/>
<table class="striped">
              <thead>
                <tr>
              ...
              <tbody>
             <tr>
                   <td>Dr. Győri Ottilia - Fidesz-KDNP <img src="images/fideszkdnp_logo.png" style="width:55px;height:30px;"></td>
				   <td id="fidesz_mayor">59.2%</td>
			</tr>
			<tr>
			<td>Hegyesi Adrien Beáta - Budakörnyék Fejlődéséért Egyesület</td> 
			<td id="ellenzek_mayor">40.8%</td>
			</tr>
              </tbody>
            </table>
<br/>
<br/>
<h5><strong><a id="webURL" href="https://static.valasztas.hu/dyn/onk14/szavossz/hu/M14/T014/tjk.html">2014-es polgármester-választás eredménye</a></strong></h5><br/>
...
<br/>
			...
			<table class="striped">
              ...
              <tbody>
             <tr>
                   <td>Dr. Csutoráné Dr. Győri Ottilia - Fidesz-KDNP <img src="images/fideszkdnp_logo.png" style="width:55px;height:30px;"></td>
				   <td id="fidesz_mayor">68.8%</td>
				   <td id="fidesz_mayor2">3,519</td>
			</tr>
			<tr>
			<td>Szél Bálint - LMP <img src="images/lmp_logo.png" style="width:52px;height:30px;"></td> 
			<td id="ellenzek_mayor">31.2%</td>
			<td id="ellenzek_mayor2">1,597</td>
			</tr>
              </tbody>
            </table>
<br/>
