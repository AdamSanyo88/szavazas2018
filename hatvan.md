...
<div class="section">
    <div class="row">
		  ...
		  <h5>Hatvan</h5>
<br/>
<h5><strong><a id="webURL" href="http://www.valasztas.hu/dyn/onk14/szavossz/hu/M10/T046/tjk.html">2014-es polgármester-választás eredménye</a></strong></h5>
<br/>
<img src="images/2014_onkormanyzat/hatvan.png" style="height: 100%; width: 100%; object-fit: contain">
			...
			<table class="striped">
              ...
              <tbody>
             <tr>
                   <td>Horváth Richárd - Fidesz-KDNP <img src="images/fideszkdnp_logo.png" style="width:55px;height:30px;"></td>
				   <td id="fidesz_mayor">65.4%</td>
				   <td id="fidesz_mayor2">4,210</td>
			</tr>
			<tr>
			<td>Palik Józsefné - EGYÜTT HATVANÉRT</td> 
			<td id="ellenzek_mayor">17.8%</td>
			<td id="ellenzek_mayor2">1,144</td>
			</tr>
              </tbody>
            </table>
<br/>
...
<br/><h5><strong>2018-as országos listás eredmények</strong></h5><br/><img src="images/listas_charts/hatvan.png" style="height: 100%; width: 100%; object-fit: contain"><br/>
