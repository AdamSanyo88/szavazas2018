...
<div class="section">
    <div class="row">
          <div class="col s12">
		  <h5>Balassagyarmat</h5>
<br/>
<h5><strong><a id="webURL" href="http://www.valasztas.hu/dyn/onk14/szavossz/hu/M13/T003/tjk.html">2014-es polgármester-választás eredménye</a></strong></h5>
<br/>
<img src="images/2014_onkormanyzat/balassagyarmat.png" style="height: 100%; width: 100%; object-fit: contain">
			...
			<table class="striped">
              ...
              <tbody>
             <tr>
                   <td>	Medvácz Lajos Ferenc - Fidesz-KDNP <img src="images/fideszkdnp_logo.png" style="width:55px;height:30px;"></td>
				   <td id="fidesz_mayor">55.8%</td>
				   <td id="fidesz_mayor2">2,686</td>
			</tr>
			<tr>
			<td>Lombos István Pál - MSZP <img src="images/mszp2_logo.png" style="width:30px;height:30px;"></td> 
			<td id="ellenzek_mayor">22.1%</td>
			<td id="ellenzek_mayor2">1,066</td>
			</tr>
              </tbody>
            </table>
<br/>
...
<br/><h5><strong>2018-as országos listás eredmények</strong></h5><br/><img src="images/listas_charts/balassagyarmat.png" style="height: 100%; width: 100%; object-fit: contain"><br/>
