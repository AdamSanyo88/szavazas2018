...
<table class="striped">
             ...
             <tr>
                  <td>Szatmáry Kristóf - Fidesz-KDNP <img src="images/fideszkdnp_logo.png" style="width:55px;height:30px;"></td>
				   <td id="id_fidesz">38.7% &emsp; <span id="id_fidesz2">(43.4%)</span></td>
			</tr>
			<tr><td>Tokody Marcell Gergely - Jobbik <img src="images/jobbik_logo.png" style="width:23px;height:30px;"></td> <td id="id_jobbik">11.6% &emsp; <span id="id_jobbik2">(9.8%)</span></td></tr>
			<tr>
			...
			<tr>
				  <td><strong>VISSZALÉPETT AZ EGYÜTT JAVÁRA</strong> - Momentum <img src="images/momentum_logo.png" style="width:44px;height:30px;"></td>
				   <td id="id_momentum">4.5% &emsp; <span id="id_momentum2">(3.2%)</span></td>
			</tr>
<tr>
<td>Vajda Zoltán -  Együtt <img src="images/egyutt_logo2.png" style="width:71px;height:30px;"></td>
 <td id="id_egyutt">7.0% &emsp; <span id="id_egyutt2">(36.3%)</span></td>
</tr>                
              </tbody>
