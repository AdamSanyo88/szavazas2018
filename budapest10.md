---
layout: page
title: Budapest X. kerület
permalink: /budapest10
---
...
<div class="section">
    <div class="row">
          <div class="col s12">
		  <h5>Budapest X. kerület</h5>
<br/>
<h5><strong><a id="webURL" href="http://www.valasztas.hu/dyn/onk14/szavossz/hu/M01/T010/tjk.html">2014-es polgármester-választás eredménye</a></strong></h5>
<br/>
<div style="position:relative;width:100%;height:0;padding-top: 68.9%;"><iframe src="https://datastudio.google.com/embed/reporting/1cNSVSA70K2eq3LFj1NolaTdcqjgr9eKE/page/8Pym" frameborder="0" style="position: absolute;width: 100%;/* object-fit: contain; */height: 100%;top: 0;left: 0;right: 0;bottom: 0;" allowfullscreen=""></iframe></div>
			...
			<table class="striped">
              ...
              <tbody>
             <tr>
                   <td>Kovács Róbert Antal - Fidesz-KDNP <img src="images/fideszkdnp_logo.png" style="width:55px;height:30px;"></td>
				   <td id="fidesz_mayor">49.5%</td>
				   <td id="fidesz_mayor2">10,585</td>
			</tr>
			<tr>
			<td>Élő Norbert - DK <img src="images/dk_logo.png" style="width:34px;height:30px;"></td> 
			<td id="ellenzek_mayor">32.9%</td>
			<td id="ellenzek_mayor2">7,038</td>
			</tr>
              </tbody>
            </table>
<br/>
...
<th>Kompenzációs helyek</th>
             ...
             <tr>
                  <td>Fidesz-KDNP <img src="images/fideszkdnp_logo.png" style="width:55px;height:30px;"></td>
				   <td id="fidesz_mp">12</td><td id="fidesz_mp_lista">0</td>
			</tr>
			...
			<tr>
                  <td>MSZP <img src="images/mszp2_logo.png" style="width:30px;height:30px;"></td>
				   <td id="mszp_mp">0</td><td id="mszp_mp_lista">3</td>
			</tr>
			<tr>
...
<br/><h5><strong>2018-as országos listás eredmények</strong></h5><br/><img src="images/listas_charts/budapest10.png" style="height: 100%; width: 100%; object-fit: contain"><br/>
