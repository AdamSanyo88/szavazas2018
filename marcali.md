...
<div class="section">
    <div class="row">
		  ...
		  <h5>Marcali</h5>
<br/>
<h5><strong><a id="webURL" href="http://www.valasztas.hu/dyn/onk14/szavossz/hu/M15/T123/tjk.html">2014-es polgármester-választás eredménye</a></strong></h5>
<br/>
<img src="images/2014_onkormanyzat/marcali.png" style="height: 100%; width: 100%; object-fit: contain">
			...
			<table class="striped">
              ...
              <tbody>
             <tr>
                   <td>Kis-Dörnyei László - Fidesz-KDNP <img src="images/fideszkdnp_logo.png" style="width:55px;height:30px;"></td>
				   <td id="fidesz_mayor">43.4%</td>
				   <td id="fidesz_mayor2">1,735</td>
			</tr>
			<tr>
			<td>Dr. Sütő László - MOTTE</td> 
			<td id="ellenzek_mayor">56.6%</td>
			<td id="ellenzek_mayor2">2,267</td>
			</tr>
              </tbody>
            </table>
<br/>
			...
			<tr>
			 ...
			 <tr>
                  <td>Egyéb szervezet</td>
				   <td id="egyeb_mp">7 *</td><td id="egyeb_mp_lista"></td>
			</tr>
             <tr>
                  <td>Független</td>
...
<p><span id="megjegyzes">* MOTTE jelölt</span><br/></p>
<br/><h5><strong>2018-as országos listás eredmények</strong></h5><br/><img src="images/listas_charts/marcali.png" style="height: 100%; width: 100%; object-fit: contain"><br/>
